    ...
    <div class="container">
        <div class="header">
            <h1 class="page-title">
                ...
                <div class="subtitle">2024-2025第2学期</div>
            </h1>
            
            <div class="update-time">
                最后更新时间：<?=$updateTime?> ｜ 访问地址：otoo.top/fzkcb ｜ <a href="?style=1<?=!empty($_GET["week"])? "&week=".$_GET["week"] : "" ?>" class="week-btn" style="padding:3px 50px">切换样式</a>
            </div>
